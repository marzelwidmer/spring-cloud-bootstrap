...
//
//	private static final String REMOTE_SERVICE_ROOT_URI = "http://localhost:4002";
//
//	private final RestTemplate rest;
//
//	public TraversonController(RestTemplate restTemplate) {
//		this.rest = restTemplate;
//	}
//
//	@GetMapping(value = "/nu")
//	public String index(M) throws URISyntaxException {
//
//		Traverson client = new Traverson(new URI(REMOTE_SERVICE_ROOT_URI), MediaTypes.HAL_JSON);
//
//		Resources<Resource<Food>> foods = client
//			.follow("foods")
//			.toObject(new ResourcesType<Resource<Food>>(){});
////		return new DiscoveredResource(provider, traverson -> traverson.follow("foods", "find"));
//
//
